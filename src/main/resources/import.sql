...
insert into review (id, rating, description) values ( 3001, '4', 'OK' );
insert into review (id, rating, description) values ( 3002, '5', 'Good' );
insert into review (id, rating, description) values ( 3003, '5', 'Great' );